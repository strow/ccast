%
% opts_L1a_j2_H4 - wrapper to process NOAA RDR to ccast L1a files
%
% SYNOPSIS
%   opts_L1a_j2_H4(year, doy)
%
% INPUTS
%   year  - integer year
...
function opts_L1a_j2_H4(year, doy)
...
ghome = '/asl/cris/geo60_j02';
rhome = '/asl/cris/rdr60_j02';
