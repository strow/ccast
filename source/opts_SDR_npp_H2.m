%
% opts_SDR_npp_H2 - wrapper to process ccast L1a to SDR files
%
% SYNOPSIS
%   opts_SDR_npp_H2(year, doy)
%
% INPUTS
%   year  - integer year
...
function opts_SDR_npp_H2(year, doy)
...
Ldir = sprintf('L1a%02d_%s_H2', nscanSC, cvers);
...
opts.inst_res = 'hires2'; % npp extended res mode
