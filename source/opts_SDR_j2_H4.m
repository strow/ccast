%
% opts_SDR_j2_H4 - wrapper to process ccast L1a to SDR files
%
% SYNOPSIS
%   opts_SDR_j2_H4(year, doy)
%
% INPUTS
%   year  - integer year
...
%
%   derived from opts_SDR_j2_H4_v3, with a2 values from eng
%

function ops_SDR_j2_H4(year, doy)
...
cctag = '21b';  % SDR file version
cvers = 'j02';  % CrIS instrument
...
opts.inst_res = 'hires4'; % j2 extended res mode
...
opts.neonWL = 703.451561; % Neon from Larrabee (for j2v1)
opts.neonWL = opts.neonWL * (1 - 4.55E-6);  % adjustment for v2
opts.orb_period = 6090;   % orbital period (seconds)

% high-res SA inverse files
opts.LW_sfile = '../inst_j2/SAinv_j2v2_LW.mat';
opts.MW_sfile = '../inst_j2/SAinv_j2v2_MW.mat';
opts.SW_sfile = '../inst_j2/SAinv_j2v2_SW.mat';
