...
% shome = '/asl/data/cris/ccast/e5_hr3';
  shome = '/asl/data/cris/ccast/e5_hi3odd';
...
opts.inst_res = 'hi3odd'; % high res #3 odd point set
...
opts.LW_sfile = '../inst_data/SAinv_HR3odd_Pn_LW.mat';
opts.MW_sfile = '../inst_data/SAinv_HR3odd_Pn_MW.mat';
opts.SW_sfile = '../inst_data/SAinv_HR3odd_Pn_SW.mat';
