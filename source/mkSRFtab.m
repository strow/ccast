...
for wi = 1 : length(wlist)
  ...
  inst = inst_params(band, wlist(wi), opt1);
  ...
  for i = 1 : inst.npts
    ...
    for j = 1 : 9
      ...
      % call newILS
      smat(:, i, j) = newILS(j, inst, inst.freq(i), inst.freq, opt2);
