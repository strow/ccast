...
dLW = load(sfile);
% opts.foax - dLW.inst.foax
isequal(opts.foax, dLW.inst.foax)
isequal(opts.frad, dLW.inst.frad)
...
dMW = load(sfile);
% opts.foax - dMW.inst.foax
isequal(opts.foax, dMW.inst.foax)
isequal(opts.frad, dMW.inst.frad)
...
dSW = load(sfile);
% opts.foax - dSW.inst.foax
isequal(opts.foax, dSW.inst.foax)
isequal(opts.frad, dSW.inst.frad)
