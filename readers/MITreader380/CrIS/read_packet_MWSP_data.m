...
% idata.MWSP(1:530,FOV,packet_counter.MWSP(FOV)) = bit_unpack_MW(idata_packed);
% qdata_packed = fread(fid,(header.packet_length-28)/4,'uint16');
% qdata.MWSP(1:530,FOV,packet_counter.MWSP(FOV)) = bit_unpack_MW(qdata_packed);

if header.packet_length==1684
idata_packed = fread(fid,(header.packet_length-28)/4,'uint16');
idata.MWSP(1:530,FOV,packet_counter.MWSP(FOV)) = bit_unpack_MW1684(idata_packed);
qdata_packed = fread(fid,(header.packet_length-28)/4,'uint16');
qdata.MWSP(1:530,FOV,packet_counter.MWSP(FOV)) = bit_unpack_MW1684(qdata_packed);
elseif header.packet_length==1896
idata_packed = fread(fid,(header.packet_length-28)/4,'uint16');
idata.MWSP(1:530,FOV,packet_counter.MWSP(FOV)) = bit_unpack_MW1896(idata_packed);
qdata_packed = fread(fid,(header.packet_length-28)/4,'uint16');
qdata.MWSP(1:530,FOV,packet_counter.MWSP(FOV)) = bit_unpack_MW1896(qdata_packed);
elseif header.packet_length==4028
idata_packed = fread(fid,(header.packet_length-28)/4,'uint16');
idata.MWSP(1:1039,FOV,packet_counter.MWSP(FOV)) = bit_unpack_MW4028(idata_packed);
qdata_packed = fread(fid,(header.packet_length-28)/4,'uint16');
qdata.MWSP(1:1039,FOV,packet_counter.MWSP(FOV)) = bit_unpack_MW4028(qdata_packed);
elseif header.packet_length==4496
idata_packed = fread(fid,(header.packet_length-28)/4,'uint16');
idata.MWSP(1:1039,FOV,packet_counter.MWSP(FOV)) = bit_unpack_MW4496(idata_packed);
qdata_packed = fread(fid,(header.packet_length-28)/4,'uint16');
qdata.MWSP(1:1039,FOV,packet_counter.MWSP(FOV)) = bit_unpack_MW4496(qdata_packed);
else
    disp(['packet_length = ', num2str(header.packet_length),', NO BIT_UNPACK AVAIABLE FOR MWSP'])
end
