...
function T = calc_instrument_temps(Temp,TempCoeffs,Nkeep)
...
%  Nkeep:       Number of 8-sec-science elements to keep.  See further info for Nkeep in ICT_countsToK.m
%
% OUTPUTS
...
%       instr_temps = calc_instrument_temps(d1.data.sci.Temp.Temp,d1.packet.TempCoeffs,Nkeep)
%
