...
%-------------------------
frq = d1.vkMW;
calc_mean = mean(d1.bkMW, 2);
obs1_mean = mean(d1.bsMW, 2);
obs2_mean = mean(d2.bsMW, 2);
...
calc_mean = mean(d1.bkMW(:, ix), 2);
obs1_mean = mean(d1.bsMW(:, ix), 2);
obs2_mean = mean(d2.bsMW(:, ix), 2);
