...
function ccast_prepro(d1, d2, year, binit)
...
% set data paths
hdir = '/asl/data/cris/rdr60/wisc';      % HDF RDR files
gdir = '/asl/data/cris/sdr60/wisc';      % HDF GCRSO files
mdir = '/asl/data/cris/ccast/rdr60_hr';  % matlab RDR files
odir = '/asl/data/cris/ccast/daily';     % matlab daily files
...
% use initial bit trim file, if provided
if nargin == 4
