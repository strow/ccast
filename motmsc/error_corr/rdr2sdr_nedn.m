...
for fi = 1 : nfile
  ...
  [avgSPLW, avgITLW, obsITLW, t_ITLW, r_ITLW, SinvLW] = ...
       calmain_nedn(instLW, userLW, rcLW, scTime, ...
                    avgLWIT, avgLWSP, sci, eng, geo, opts);

  [avgSPMW, avgITMW, obsITMW, t_ITMW, r_ITMW, SinvMW] = ...
       calmain_nedn(instMW, userMW, rcMW, scTime, ...
                    avgMWIT, avgMWSP, sci, eng, geo, opts);

  [avgSPSW, avgITSW, obsITSW, t_ITSW, r_ITSW, SinvSW] = ...
       calmain_nedn(instSW, userSW, rcSW, scTime, ...
