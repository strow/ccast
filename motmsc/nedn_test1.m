%
% nedn_test1 -- browse NOAA NEdN values
%
...
for di = sdays
  ...
  for fi = 1 : length(flist);
    ...
    switch(band)
      case 'LW', rtmp = pd.ES_NEdNLW; vtmp = wn_lw';
      case 'MW', rtmp = pd.ES_NEdNMW; vtmp = wn_mw';
      case 'SW', rtmp = pd.ES_NEdNSW; vtmp = wn_sw';
    end
