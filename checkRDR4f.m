%
% NAME
%   checkRDR4f.m - validate RDR data from the MIT reader
%
% SYNOPSIS
...
%
% AUTHOR
%   H. Motteler, 20 Oct 11
%

function [igmLW, igmMW, igmSW, igmTime, igmFOR] = checkRDR4f(d1, rid);
...
% t2(isnan(t2)) = -1;
% if ~isequal(t1,t2)
%    fprintf(1, 'checkRDR: LW FOV FORs differ, index %d file %s\n', ri, rid);
% end
