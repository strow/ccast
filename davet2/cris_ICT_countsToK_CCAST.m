...
function OUT = cris_ICT_countsToK_CCAST(Temp,TempCoeffs,Nkeep)

%
% function OPUT = cris_ICT_countsToK_CCAST(Temp,TempCoeffs,Nkeep)
%
...
%
% History:
%   Renamed cris_ICT_countsToK_CCAST.m and adapted by DCT on 4 Nov 2011 to work with MIT reader packets.
%   cris_ICT_countsToK_TVAC3 created by JKT, SSEC, University of Wisconsin-Madison
